...
function HaeruData(d, e) {
    if (d.Job == "") {
        var schPets = ["朝日小仙女", "夕月小仙女", "요정", "Eos", "Selene", "フェアリー"];
        var smnPets = ["迦楼罗之灵", "泰坦之灵", "伊弗利特之灵", "黄宝石兽", "绿宝石兽", "红宝石兽", "에기", "카벙클", "Carbuncle", "Egi", "エギ", "カーバンクル", "데미바하무트", "Demi-Bahamut"];
        var mchPets = ["车式浮空炮塔", "象式浮空炮塔", "자동포탑", "Autoturret", "オートタレット", "Selbstschuss-Gyrocopter", "Auto-tourelle"];
    ...
    if (d.maxhit == "") {
        ...
        if(this.MaxHitStr == "Unknown" && this.Class == "MCH" && localStorage.getItem("lang") == "1")
