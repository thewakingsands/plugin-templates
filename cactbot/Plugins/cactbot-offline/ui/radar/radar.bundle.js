...
class Radar {
  constructor(options, table) {
    ...
    this.regexes = {
      ability: netregexes/* default.ability */.ZP.ability(),
      addedCombatant: netregexes/* default.addedCombatant */.ZP.addedCombatant(),
  ...
  AddMonster(log, hunt, matches) {
    ...
    // option overwrite
    if (hunt.rank && hunt.rank in options.RankOptions) options = Object.assign({}, this.options, options.RankOptions[hunt.rank]);
  ...
  UpdateMonsterDom(monster) {
    ...
    if (node && node instanceof HTMLElement) {
      ...
      if (monster.puller !== undefined) node.innerHTML += `&nbsp;&nbsp;${monster.puller}`;
