...
;// CONCATENATED MODULE: ./ui/dps/rdmty/dps.js
...
var formatNumber = function (number) {
  ...
  if (number >= 1000) return (number / 1000).toFixed(2) + 'K';else if (number >= 1000000) return (number / 1000000).toFixed(2) + 'M';
  return number.toFixed(2);
};
const ____Class0 = React.Component;
for (const ____Class0____Key in ____Class0) {
  if (____Class0.hasOwnProperty(____Class0____Key)) CombatantCompact[____Class0____Key] = ____Class0[____Class0____Key];
}
...
function CombatantCompact() {
  if (____Class0 !== null) ____Class0.apply(this, arguments);
}
Object.defineProperty(CombatantCompact.prototype, 'jobImage', {
  writable: true,
  configurable: true,
  value: function (job) {
    if (window.JSFIDDLE) return window.GLOW_ICONS[job.toLowerCase()];
...
Object.defineProperty(CombatantCompact.prototype, 'render', {
  ...
  value: function () {
    ...
    return this.props.perSecond === '---' ? null : React.createElement('li', {
      ...
      className: 'total'
    }, this.props.totalFormatted), this.props.additional ? React.createElement('span', {
      className: 'additional'
    }, '[', this.props.additional, ']') : null, '(', React.createElement('span', {
      className: 'ps'
    }, this.props.perSecond, ','), React.createElement('span', {
      className: 'percent'
    }, this.props.percentage), ')'), React.createElement('div', {
      className: 'info'
    }, React.createElement('span', {
      className: 'job-icon'
      ...
      className: 'rank'
    }, this.props.rank, '.'), React.createElement('span', {
      className: 'character-name'
    }, this.props.characterName), React.createElement('span', {
...
for (const ____Class1____Key in ____Class1) {
  if (____Class1.hasOwnProperty(____Class1____Key)) ChartView[____Class1____Key] = ____Class1[____Class1____Key];
}
...
function ChartView() {
  if (____Class1 !== null) ____Class1.apply(this, arguments);
}
...
for (const ____Class2____Key in ____Class2) {
  if (____Class2.hasOwnProperty(____Class2____Key)) Header[____Class2____Key] = ____Class2[____Class2____Key];
}
...
Object.defineProperty(Header.prototype, 'render', {
  ...
  value: function () {
    ...
    }, encounter.title, React.createElement('div', {
    ...
    }, 'Current Fight'), EncountersArray.map((encounter, i) => {
      return React.createElement('div', {
        key: i,
    ...
    }, formatNumber(encounter.damage))), React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'DPS'), React.createElement('span', {
      className: 'value ff-text'
    ...
    React.createElement('div', {
      ...
      className: 'label ff-header'
    }, 'Crits'), React.createElement('span', {
      className: 'value ff-text'
    }, formatNumber(100 / encounter.hits * encounter.crithits) + '%')), React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'Miss'), React.createElement('span', {
      className: 'value ff-text'
    }, encounter['misses'])), React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'Max'), React.createElement('span', {
      className: 'value ff-text'
    }, encounter.maxhit))), React.createElement('div', {
      className: 'extra-row healing'
    }, React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'Heals'), React.createElement('span', {
      className: 'value ff-text'
    }, formatNumber(encounter.healed))), React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'HPS'), React.createElement('span', {
      className: 'value ff-text'
    }, formatNumber(encounter.enchps))), React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'Crits'), React.createElement('span', {
      className: 'value ff-text'
    }, encounter['critheal%'])), React.createElement('div', {
      className: 'cell'
    }, React.createElement('span', {
      className: 'label ff-header'
    }, 'Max'), React.createElement('span', {
...
for (const ____Class3____Key in ____Class3) {
  if (____Class3.hasOwnProperty(____Class3____Key)) Combatants[____Class3____Key] = ____Class3[____Class3____Key];
}
...
function Combatants() {
  if (____Class3 !== null) ____Class3.apply(this, arguments);
}
Object.defineProperty(Combatants.prototype, 'shouldComponentUpdate', {
  ...
  value: function (nextProps) {
    ...
    if (Object.getOwnPropertyNames(nextProps.data).length === 0) return false;
    return true;
  }
});
      ...
      if (combatant.Job !== '') {
        ...
        if (this.props.currentView === 'Healing') {
          if (parseInt(combatant.healed, 10) > 0) {
            if (!maxdps) maxdps = parseFloat(combatant.healed);
            stats = {
              job: combatant.Job || '',
          ...
          if (parseInt(combatant.damagetaken, 10) > 0) {
            if (!maxdps) maxdps = parseFloat(combatant.damagetaken);
            stats = {
              job: combatant.Job || '',
              characterName: combatant.name,
          ...
          if (!maxdps) maxdps = parseFloat(combatant.damage);
          stats = {
            job: combatant.Job || '',
            characterName: combatant.name,
        ...
        if (stats) {
          rows.push(React.createElement(CombatantCompact, React.__spread({
            onClick: this.props.onClick,
...
for (const ____Class4____Key in ____Class4) {
  if (____Class4.hasOwnProperty(____Class4____Key)) DamageMeter[____Class4____Key] = ____Class4[____Class4____Key];
}
...
Object.defineProperty(DamageMeter.prototype, 'shouldComponentUpdate', {
  ...
  value: function (nextProps, nextState) {
    if (nextProps.parseData.Encounter.encdps === '---') return false;
    if (this.state.currentViewIndex !== nextState.currentViewIndex) return true;
    if (this.state.selectedEncounter) return false;
    return true;
  }
});
Object.defineProperty(DamageMeter.prototype, 'componentWillReceiveProps', {
  ...
  value: function (nextProps) {
    ...
    if (this.props.parseData.Encounter.title === 'Encounter' && nextProps.parseData.Encounter.title !== 'Encounter') {
      ...
      if (EncountersArray.length > 10) EncountersArray.pop();
    }
  }
});
...
Object.defineProperty(DamageMeter.prototype, 'handleViewChange', {
  ...
  value: function (e) {
    ...
    if (index > this.props.chartViews.length - 2) index = 0;else index++;
    this.setState({
    ...
    if (this.state.selectedEncounter) {
      ...
      if (this.state.currentViewIndex === 1) {
        data = _.sortBy(_.filter(data, d => {
          ...
          if (this.state.currentViewIndex === 1) return -parseInt(d.healed, 10);
        });
      } // Tanking
        ...
        data = _.sortBy(_.filter(data, d => {
          ...
          if (this.state.currentViewIndex === 2) return -parseInt(d.damagetaken, 10);
        });
      }
    }
    return React.createElement('div', {
...
function onOverlayDataUpdate(e) {
  ...
  React.render(React.createElement(DamageMeter, {
    parseData: e.detail
  }), container);
...
user_config/* default.getUserConfigLocation */.Z.getUserConfigLocation('rdmty', defaultOptions, () => {
  const options = {
    ...defaultOptions
  };
