...
const data = {
  ...
  131: {
    'rates': [15, 60, 85, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Rain']
  },
  132: {
    'rates': [10, 20, 25, 40, 80, 100],
    'weathers': ['Fog', 'Rain', 'Showers', 'Clear Skies', 'Fair Skies', 'Clouds']
  },
  133: {
    'rates': [45, 50, 55, 60, 85, 95, 100],
    'weathers': ['Snow', 'Thunder', 'Rain', 'Fog', 'Clouds', 'Fair Skies', 'Clear Skies']
  },
  134: {
    'rates': [25, 40, 85, 100],
    'weathers': ['Clouds', 'Umbral Wind', 'Fair Skies', 'Clear Skies']
  },
  135: {
    'rates': [15, 30, 100],
    'weathers': ['Umbral Wind', 'Moon Dust', 'Fair Skies']
  },
  136: {
    'rates': [15, 85, 100],
    'weathers': ['Astromagnetic Storm', 'Fair Skies', 'Umbral Wind']
  },
  137: {
    'rates': [10, 50, 70, 85, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Fog', 'Snow']
  },
  138: {
    'rates': [10, 25, 40, 80, 100],
    'weathers': ['Fog', 'Rain', 'Clear Skies', 'Fair Skies', 'Clouds']
  },
  139: {
    'rates': [100],
    'weathers': ['Polarization']
  },
  140: {
    'rates': [100],
    'weathers': ['Projection']
  ...
  144: {
    'rates': [100],
    'weathers': ['Inevitability']
  },
  145: {
    'rates': [100],
    'weathers': ['Pandæmonium']
  },
  146: {
    'rates': [100],
    'weathers': ['Termination']
  ...
  147: {
    'rates': [100],
    'weathers': ['Transcendence']
  },
  148: {
    'rates': [25, 70, 80, 90, 95, 100],
    'weathers': ['Clear Skies', 'Fair Skies', 'Clouds', 'Rain', 'Fog', 'Showers']
  },
  149: {
    'rates': [100],
    'weathers': ['Vacuity']
  ...
  151: {
    'rates': [50, 65, 80, 95, 100],
    'weathers': ['Fair Skies', 'Clouds', 'Fog', 'Rain', 'Thunderstorms']
  },
  152: {
    'rates': [50, 65, 80, 95, 100],
    'weathers': ['Fair Skies', 'Clouds', 'Fog', 'Rain', 'Showers']
  ...
  153: {
    'rates': [40, 55, 70, 90, 100],
    'weathers': ['Fair Skies', 'Clouds', 'Fog', 'Wind', 'Thunder']
  },
  154: {
    'rates': [50, 65, 80, 95, 100],
    'weathers': ['Fair Skies', 'Clouds', 'Fog', 'Rain', 'Showers']
...
const getWeather = (timeMs, zoneId) => {
  ...
  const rateIdx = zone_info/* default */.Z[zoneId]?.weatherRate;
  if (!rateIdx) return;
...
const zoneInfoAnemos = {
  mapImage: anemos_namespaceObject,
  mapWidth: 1300,
  mapHeight: 950,
  shortName: 'anemos',
  hasTracker: true,
...
const zoneInfoBozjaSouthern = {
  mapImage: bozjasouthern_namespaceObject,
  mapWidth: 1600,
  mapHeight: 1400,
...
const zoneInfoHydatos = {
  mapImage: hydatos_namespaceObject,
  mapWidth: 1500,
  mapHeight: 800,
  shortName: 'hydatos',
  hasTracker: true,
...
const zoneInfoPagos = {
  mapImage: pagos_namespaceObject,
  mapWidth: 1500,
  mapHeight: 950,
  shortName: 'pagos',
  hasTracker: true,
...
;// CONCATENATED MODULE: ./ui/eureka/pyros.png
const pyros_namespaceObject = __webpack_require__.p + "ui/eureka/pyros.png";
...
const zoneInfoPyros = {
  mapImage: pyros_namespaceObject,
  mapWidth: 1350,
  mapHeight: 1450,
  shortName: 'pyros',
  hasTracker: true,
...
;// CONCATENATED MODULE: ./ui/eureka/zadnor.png
const zadnor_namespaceObject = __webpack_require__.p + "ui/eureka/zadnor.png";
...
const zoneInfoZadnor = {
  mapImage: zadnor_namespaceObject,
  mapWidth: 1600,
  mapHeight: 1400,
  shortName: 'zadnor',
  hasTracker: false,
...
const defaultOptions = {
  ...
  Regex: {
    ...
    en: {
      flagRegex: netregexes/* default.gameLog */.ZP.gameLog({
        code: '00..',
        line: '(?<before>.*)\ue0bb(?:Eureka (?:Anemos|Pagos|Pyros|Hydatos)|Bozjan Southern Front|Zadnor) \\( (?<x>\\y{Float})\\s*, (?<y>\\y{Float}) \\)(?<after>.*?)'
      }),
      trackerRegex: netregexes/* default.gameLog */.ZP.gameLog({
        line: '.*?(?:https://)?ffxiv-eureka\\.com/(?<id>[_\\w-]{6}).*?'
      }),
      importRegex: netregexes/* default.gameLog */.ZP.gameLog({
        code: '00..',
        line: '.*?NMs on cooldown: (?<nms>\\S.*\\))*?'
      }),
      timeRegex: regexes/* default.parse */.Z.parse(/(.*) \((\d*)m\)/)
    },
    cn: {
      flagRegex: netregexes/* default.gameLog */.ZP.gameLog({
        code: '00..',
      ...
      timeRegex: regexes/* default.parse */.Z.parse(/(.*) \((\d*)分(钟*)\)/)
    },
    ko: {
      flagRegex: netregexes/* default.gameLog */.ZP.gameLog({
        code: '00..',
        line: '(?<before>.*)\ue0bb(?:에우레카: (?:아네모스|파고스|피로스|히다토스) 지대|남부 보즈야 전선|자트노르 고원) \\( (?<x>\\y{Float})\\s*, (?<y>\\y{Float}) \\)(?<after>.*?)'
      }),
      trackerRegex: netregexes/* default.gameLog */.ZP.gameLog({
        line: '.*?(?:https://)?ffxiv-eureka\.com\/(?<id>[_\\w-]{6}).*?'
      }),
      ...
      timeRegex: regexes/* default.parse */.Z.parse(/(.*) \((\d*)분\)/)
    }
  },
  ZoneInfo: {
...
class EurekaTracker {
  ...
  activeFates = new Set();
  activeCEs = new Set();
  fateRegex = netregexes/* default.fateDirector */.ZP.fateDirector();
  ceRegex = netregexes/* default.ceDirector */.ZP.ceDirector();
  currentTracker = '';
  ...
  EntityToMapX(x) {
    if (!this.zoneId) throw new not_reached/* UnreachableCode */.$();
  ...
  AddElement(container, nmKey) {
    ...
    if (nm.isDuel) label.classList.add('duel');
    ...
    if (this.zoneInfo.treatNMsAsSkirmishes) {
      if (this.options.CompleteNamesSTQ) {
        ...
        if (shortLabel !== undefined) name.innerText = shortLabel;
  ...
  InitNMs() {
    ...
    if (this.zoneInfo.fairy) {
      ...
      this.fairyRegex = netregexes/* default.addedCombatant */.ZP.addedCombatant({
        name: fairyName
      });
    }
  ...
  OnChangeZone(e) {
    ...
    while (flags?.lastChild) flags.removeChild(flags.lastChild);
  }
  RespawnTime(nm) {
  ...
  ProcessFateQueue() {
    for (const fate of this.fateQueue) this.OnFateLine(fate);
    this.fateQueue = [];
  }
  ProcessCEQueue() {
    for (const ce of this.ceQueue) this.OnCELine(ce);
    this.ceQueue = [];
  }
  UpdateTimes() {
    ...
    for (const nm of Object.values(this.nms)) {
      ...
      if (remainingMs <= 0) {
        ...
        if (!this.zoneInfo?.treatNMsAsSkirmishes) element.classList.add('nm-down');
      }
    }
  }
  ...
  OnNetLog(e) {
    ...
    if (type === netlog_defs/* default.GameLog.type */.Z.GameLog.type) {
      ...
      if (flag !== undefined && flag.x !== undefined && flag.y !== undefined) {
        this.AddFlag(parseFloat(flag.x), parseFloat(flag.y), flag.before ?? '', flag.after ?? '');
      }
      ...
      if (tracker?.id !== undefined) this.currentTracker = tracker.id;
      const importRegex = this.TransByParserLang(this.options.Regex).importRegex;
      const imp = importRegex.exec(log)?.groups;
      if (imp?.nms !== undefined) this.ImportFromTracker(imp.nms);
    } else if (type === netlog_defs/* default.AddedCombatant.type */.Z.AddedCombatant.type && this.fairyRegex) {
      const fairy = this.fairyRegex.exec(log)?.groups;
      if (fairy) this.AddFairy(fairy);
    } else if (type === netlog_defs/* default.FateDirector.type */.Z.FateDirector.type) {
      this.OnFateLine(this.fateRegex.exec(log)?.groups);
    } else if (type === netlog_defs/* default.CEDirector.type */.Z.CEDirector.type) {
