...
const bossFightTriggers = [{
  ...
  // 23F4 Dualcast
  startRegex: {
    en: netregexes/* default.ability */.ZP.ability({
      source: 'Exdeath',
      id: '23F4'
    }),
    de: netregexes/* default.ability */.ZP.ability({
      source: 'Exdeath',
      id: '23F4'
    }),
    fr: netregexes/* default.ability */.ZP.ability({
      source: 'Exdeath',
      id: '23F4'
    }),
    ja: netregexes/* default.ability */.ZP.ability({
      source: 'エクスデス',
      id: '23F4'
    }),
    cn: netregexes/* default.ability */.ZP.ability({
      source: '艾克斯迪司',
      id: '23F4'
    }),
    ko: netregexes/* default.ability */.ZP.ability({
      source: '엑스데스',
      id: '23F4'
    })
  },
  ...
  startRegex: {
    en: netregexes/* default.startsUsing */.ZP.startsUsing({
      source: 'Kefka',
      id: '28C2'
    }),
    de: netregexes/* default.startsUsing */.ZP.startsUsing({
      source: 'Kefka',
      id: '28C2'
    }),
    fr: netregexes/* default.startsUsing */.ZP.startsUsing({
      source: 'Kefka',
      id: '28C2'
    }),
    ja: netregexes/* default.startsUsing */.ZP.startsUsing({
      source: 'ケフカ',
      id: '28C2'
    }),
    cn: netregexes/* default.startsUsing */.ZP.startsUsing({
      source: '凯夫卡',
      id: '28C2'
    }),
    ko: netregexes/* default.startsUsing */.ZP.startsUsing({
      source: '케프카',
      id: '28C2'
    })
  },
...
const getLocaleObject = (object, lang) => {
...
class PullCounter {
  ...
  party = [];
  bosses = [];
  resetRegex = netregexes/* default.echo */.ZP.echo({
    line: '.*pullcounter reset.*?'
  });
  wipeEndRegex = netregexes/* commonNetRegex.userWipeEcho */.sL.userWipeEcho;
  wipeFadeInRegex = netregexes/* commonNetRegex.wipe */.sL.wipe;
  pullCounts = {};
  bossStarted = false;
  ...
  OnNetLog(e) {
    ...
    for (const boss of this.bosses) {
      if (boss.startRegex && getLocaleObject(boss.startRegex, this.options.ParserLanguage).test(log)) {
        this.OnFightStart(boss);
        return;
      }
    }
    const type = e.line[0];
    if (type !== netlog_defs/* default.GameLog.type */.Z.GameLog.type && type !== netlog_defs/* default.ActorControl.type */.Z.ActorControl.type) return;
    if (this.resetRegex.test(log)) this.ResetPullCounter();
    if (this.wipeEndRegex.test(log) || this.wipeFadeInRegex.test(log)) this.Wipe();
  ...
  SetSaveData(e) {
    ...
    try {
      ...
      if (parsed === null || typeof parsed !== 'object') throw new Error(e.data);
...
user_config/* default.getUserConfigLocation */.Z.getUserConfigLocation('pullcounter', defaultOptions, () => {
  ...
  (0,overlay_plugin_api/* addOverlayListener */.PS)('LogLine', e => pullcounter.OnNetLog(e));
